        ...
        <div className="flex h-screen bg-background text-foreground overflow-hidden">
            ...
            <aside className="w-80 border-r border-white/10 flex flex-col glass bg-black/20">
                <div className="p-6 border-b border-white/10">
                    <h2 className="text-xl font-bold tracking-tight text-white mb-2">Deal Flow</h2>
                    <button
                            ...
                            >
                                ...
                                {analyzing ? (
                                    ...
                                    <>
                                        ...
                                        <p className="text-gray-400 max-w-sm text-center">Drag & drop your PDF here, or click to browse. We'll analyze it against your thesis instantly.</p>
                                    </>
                                )}
                            </div>
